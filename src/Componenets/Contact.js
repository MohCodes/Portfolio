            ...
            <div className="formContainer">
                <form action={formAction} method="POST"  onClick={formOnClick} className="contactForm">
                    <div className="inputContainer">
                        ...
                        <input name="Name" required type="text" id = "nameInput" placeholder="John Smith"></input>
                    </div>

                    <div className="inputContainer">
                        <label htmlFor="emailInput" className="nameInput input"> Email </label>
                        <input name="Email" required type="email" id = "emailInput" placeholder="example@example.com"></input>
                    </div>
                    ...
                    <div className="inputContainer messageInputContainer">
                        ...
                        <textarea name="Message" required className="messageInput" type="textarea" id = "messageInput" placeholder="Message"></textarea>
                    </div>
